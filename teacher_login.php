    ...
    <head>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql = "SELECT * FROM admin WHERE admin_username='$username' AND admin_pass='$pass' ";
                ...
                if($num == 1)
                {
                    ...
                    echo"window.location = 'teacher_viewattendance.php';";
                    ...
                    <form action="#" method="POST">
                        <table>
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="login_username" autocomplete="off"></td>
                            </tr>
