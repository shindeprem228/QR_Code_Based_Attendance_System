...
<section id="container">
    ...
    <div id="add-main"> 
        <?php
            ...
            $sql = " SELECT * FROM students ORDER BY stud_sem , stud_shift , stud_roll";
        ...
        <center>
            <div class="container" style="margin-top:120px;" > 
                <a href="teacher_addstudents.php" class="new_btn">+ Add New Student</a> <br><br> <br>
                ...
                <table class=" table table-primary table-striped table-hover tab table-bordered " style="border:1px solid black;">
                    ...
                    ?>
                        ...
                        <td><a onClick="return confirm('Are you sure want to update this students details ?');" href="teacher_updatestudent.php?stu_en=<?php echo $row['stud_enroll'];?>"  title="Update Student Details"><i style="color:green;" class="fa-solid fa-edit"></i></a></td>
                        <td><a onClick="return confirm('Are you sure want to delete this students details ?');" href="teacher_deletestudent.php?stu_en=<?php echo $row['stud_enroll'];?>"  title="Delete Student Details"><i style="color:red;" class="fa-solid fa-trash-can"></i></a></td>
                        <!-- <td><a href="admin_delete_passenger.php?psn_id=<?php echo $pass_id;?>"><i  onClick="return confirm('Are you sure want to delete this details ?');" title="Delete Flight Details"></i></a></td> -->
                        ...
                        {
                            echo "<tr><td style='text-align:center; color:red;' colspan='8'><h1> No Students Added Yet </h1></td></tr>" ;
                        }
