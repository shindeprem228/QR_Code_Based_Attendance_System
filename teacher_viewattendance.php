            ...
            <div class="container" style="margin-top:120px;" > 
                ...
                <tbody>
                    ...
                    if($batch == 'A1' or $batch == 'A2' or $batch == 'A3' or $batch == 'B1' or $batch == 'B2' or $batch == 'B3')
                    {
                        ...
                        $sql = "SELECT students.stud_enroll , students.stud_name , students.stud_sem , students.stud_branch , students.stud_shift , students.stud_roll , students.stud_batch, attendance.att_date, attendance.att_day, attendance.att_subject, attendance.att_slot, attendance.att_batch, attendance.att_enroll , attendance.att_time FROM students LEFT JOIN attendance ON students.stud_enroll = attendance.att_enroll WHERE attendance.att_date BETWEEN '$start_date' AND '$end_date' AND attendance.att_subject = '$subject' AND attendance.att_batch = '$batch' ORDER BY attendance.att_date  ";
                    ...
                    if($batch == 'A_Div')
                    {
                        ...
                        ?>
                            <tr>
                                ...
                                <!-- <td class="text-success"><?php echo $row3['att_status']; ?></td> -->
              ...
              <?php } } 
                        ...
                        //elseif ($batch == 'B1' or $batch == 'B2' or $batch == 'B3')
                        {
                            ...
                            // $sql4 = "SELECT * FROM attendance WHERE att_date BETWEEN '$start_date' AND '$end_date' AND att_subject='$subject' AND att_batch IN (select att_batch from attendance) ";
