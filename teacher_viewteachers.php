...
<section id="container">
    ...
    <div id="add-main"> 
        <?php
            ...
            $sql = " SELECT * FROM teachers ORDER BY teach_id";
        ...
        <center>
            <div class="container" style="margin-top:120px;" > 
                <a href="teacher_addteachers.php" class="new_btn">+ Add New Teacher</a> <br><br> <br>
                ...
                <table class="table table-primary table-striped table-hover tab table-bordered " style="border:1px solid black;">
                    ...
                    ?>
                        ...
                        <td><?php echo $row['teach_edu']; ?></td>
                        <td><?php echo $row['teach_des']; ?></td>
                        <td><?php echo $row['teach_branch']; ?></td>
                        ...
                        <td><a onClick="return confirm('Are you sure want to update this teacher details ?');" href="teacher_updateteacher.php?te_id=<?php echo $row['teach_id'];?>"  title="Update Teacher Details"><i style="color:green;" class="fa-solid fa-edit"></i></a></td>
                        <td><a onClick="return confirm('Are you sure want to delete this teacher details ?');" href="teacher_deleteteacher.php?te_id=<?php echo $row['teach_id'];?>"  title="Delete Teacher Details"><i style="color:red;" class="fa-solid fa-trash-can"></i></a></td>
                        ...
                        {
                            echo "<tr><td style='text-align:center; color:red;' colspan='8'><h1> No Teachers Added Yet </h1></td></tr>" ;
                        }
