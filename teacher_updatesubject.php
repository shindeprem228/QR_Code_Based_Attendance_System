<?php
    ...
    $query = "SELECT * FROM subjects where sub_code = '$code' ";
...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                var sub_code = document.forms["updSub"]["sub_code"].value;
                ...
                var sub_name = document.forms["updSub"]["sub_name"].value;
                if(sub_name == "")
                {
                ...
                var sub_abb = document.forms["updSub"]["sub_abb"].value;
                if(sub_abb.length != 3)
                {
...
<section id="container">
    ...
    <div class="card">
        <div class="card-header" style="background-color:rgb(1, 183, 255)">
            <center><h3>Update Subject Details</h3></center>
        </div>
        <div class="card-body">
            <center>
            <form name="updSub" action="#" method="POST" onSubmit="return formvalidation()">
                <table>
                    <tr>
                        <td><h5>Subject Code:</h5></td>
                        <td><input readonly class="form-control" value="<?php echo $result['sub_code']?>" style="width:250px;" type="number" name="sub_code" placeholder="Enter 5 Digits"></td>
                    </tr>

                    <tr>
                        <td><h5>Subject Description:</h5></td>
                        <td><input class="form-control" value = "<?php echo $result['sub_name']?>" style="width:250px;" type="text" name="sub_name"></td>
                    </tr>
                   
                    <tr>
                        <td><h5>Subject Abbrevation:</h5></td>
                        <td><input class="form-control" value = "<?php echo $result['sub_abb']?>" style="width:250px;" type="text" name="sub_abb" placeholder="Enter 3 Characters"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h5>
                                <select class="form-select" style="width:250px;" name="sub_sem">
                                        <option value="1"
                                        <?php
                                                if($result['sub_sem'] == '1')
                                                {
                        ...
                        <td>
                            <h5>
                                <select class="form-select" name="sub_teacher_id">
                                    ...
                                    ?>
                                    <option value="<?php echo $row1['teach_id']?>"
                                    <?php
                                                if($result['sub_teacher_id'] == $row1['teach_id'])
                                                {
                                                    echo "selected";
                                                }
                                            ?>   
                                    ><?php echo $row1['teach_name']?></option>
                                    <?php 
                                        }
                                    ?>
                                </select>
...
<?php 
        ...
        if (isset($_POST['update']))
        {
            ...
            $sql = "UPDATE subjects SET sub_code = '$sub_code' , sub_name = '$sub_name' , sub_abb = '$sub_abb' , sub_sem = '$sub_sem' , sub_branch = '$sub_branch' , sub_teacher_id = '$sub_teacher_id'  WHERE sub_code = '$code' " ;
            $res= mysqli_query($conn,$sql) or die (mysqli_error($conn));

            if($res)
            {
              echo"<script>";
              echo"window.alert('Subject Updated Successfully....!');";
            ...
            {
              echo"<script>";
              echo"window.alert('Subject Not Updated...!');";
              echo"window.location = 'teacher_viewsubjects.php';";
              echo"</script>";
            }
        }
