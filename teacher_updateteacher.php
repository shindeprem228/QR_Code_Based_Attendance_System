<?php
    ...
    $query = "SELECT * FROM teachers where teach_id = '$id' ";
...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
                var teach_id = document.forms["updTeach"]["teach_id"].value;
                ...
                var teach_name = document.forms["updTeach"]["teach_name"].value;
                if(teach_name == "")
                {
                ...
                var show = document.forms["updTeach"]["show"].value;
                if(show.length < 8)
                {
...
<section id="container">
    ...
    <div class="card">
        <div class="card-header" style="background-color:rgb(1, 183, 255)">
            <center><h3>Update Teacher Details</h3></center>
        </div>
        <div class="card-body">
            <center>
            <form name="updTeach" action="#" method="POST" onSubmit="return formvalidation()">
                <table>
                    <tr>
                        <td><h5>Teacher ID:</h5></td>
                        <td><input readonly class="form-control" value = "<?php echo $result['teach_id']?>" style="width:250px;" type="number" name="teach_id" placeholder="Enter 2 Digits"></td>
                    </tr>

                    <tr>
                        <td><h5>Teacher Name:</h5></td>
                        <td><input class="form-control" value = "<?php echo $result['teach_name']?>"  style="width:250px;" type="text" name="teach_name" placeholder="First        Middle         Last "></td>
                    </tr>
                        ...
                        <td>
                            <select class="form-select" name="teach_edu">
                                <option value="B.E / B.Tech"
                                            <?php
                                                if($result['teach_edu'] == 'B.E / B.Tech')
                                                {
                                                    echo "selected";
                                                }
                                            ?>
                                ...
                                <?php
                                                if($result['teach_edu'] == 'M.E / M.Tech')
                                                {
                                                    echo "selected";
                                                }
                                            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-select" name="teach_des">
                                ...
                                <?php
                                                if($result['teach_des'] == 'Senior Lecturer')
                                                {
                                                    echo "selected";
                                                }
                                            ?>
                                >Senior Lecturer</option>
                                <option value="Selection Grade Lecturer"
                                <?php
                                                if($result['teach_des'] == 'Selection Grade Lecturer')
                                                {
                                                    echo "selected";
                                                }
                                            ?>
                                >Selection Grade Lecturer</option>
                                <option value="Head Of Department"
                                <?php
                                                if($result['teach_des'] == 'Head Of Department')
                                                {
                                                    echo "selected";
                                                }
                                            ?>
                    ...
                    <tr>
                        ...
                        <td>
                        <h5><input class="form-control" type="password" name="teach_pass" value="<?php echo $result['teach_pass']?>" id="show"></h5>
...
<?php 
        ...
        if (isset($_POST['update']))
        {
            ...
            // $sql="INSERT INTO teachers(teach_id,teach_name,teach_edu,teach_des,teach_branch) VALUES ('$teach_id','$teach_name','$teach_edu','$teach_des','$teach_branch')";
            $sql = "UPDATE teachers SET teach_id = '$teach_id' , teach_name = '$teach_name' , teach_edu = '$teach_edu' , teach_des = '$teach_des' , teach_branch = '$teach_branch' , teach_pass = '$teach_pass' WHERE teach_id = '$id' " ;
            $res= mysqli_query($conn,$sql) or die (mysqli_error($conn));

            if($res)
            {
              echo"<script>";
              echo"window.alert('Teacher Updated Successfully....!');";
            ...
            {
              echo"<script>";
              echo"window.alert('Teacher Not Updated...!');";
              echo"window.location = 'teacher_viewteachers.php';";
              echo"</script>";
            }
        }
